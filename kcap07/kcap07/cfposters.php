...
<h1>K-CAP 2007: Call for Posters</h1>

<h2>The Fourth International Conference on Knowledge Capture</h2>

<h2>28-31 October 2007, Whistler, BC</h2>

<h2>Website: <a href="index.html">http://www.csd.abdn.ac.uk/kcap07/</a></h2>
...
<ul>
  <li> Knowledge Engineering &amp; modelling methodologies</li>
  <li> Knowledge Engineering &amp; the Semantic Web</li>
  <li> Mixed-initiative planning &amp; decision-support tools</li>
  <li> Acquisition of problem-solving knowledge</li>
  <li> Knowledge-based markup techniques</li>
  <li> Knowledge extraction systems</li>
  <li> Knowledge acquisition tools</li>
  <li> Advice taking systems</li>
</ul>

<h2>IMPORTANT DATES</h2>
  <table border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td>Workshops / Tutorials proposals due
            </td>
            <td>20 April 2007
            </td>
          </tr>
		  ...
		  <tr>
            <td>Technical papers deadline 
            </td>
            <td>9 May 2007 at 11:59pm IDLW (UTC -12)
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>1 July 2007 at 11:59pm IDLW (UTC -12)
            </td>
          </tr>
          
		  <tr>
            <td>Workshops / Tutorials 
            </td>
            <td>28 October 2007
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>29-31 October 2007
            </td>
          </tr>
      </table>

<h2>Invited Speakers - Luis von Ahn and Oren Etzioni</h2>
<h3>About Luis von Ahn</h3>
	<p>
		...
		Fellowship, and was named one of Popular Science Magazine's &ldquo;Brilliant
		10&rdquo; scientists of 2006. His research interests include encouraging
		people to do work for free, as well as catching
		and thwarting cheaters in online environments.
	</p>
	  
	  <h3>About Oren Etzioni</h3>
	<p>
...
<h2>Poster Papers</h2>
<p>
Complete formatting instructions (including Microsoft Word and Latex templates) are <a href="posterguide.php">available on the conference website</a>. Briefly, submitted papers should be 2 pages, two columns, 10-point Times Roman (or equivalent), and &quot;US letter&quot; page-size. (Poster papers due 1 July 2007).
<p>
...
<ul>
   <li> Whistler - <a href="http://www.whistler.ca/" rel="external">http://www.whistler.ca/</a> </li>
   <li> Whistler.com - <a href="http://www.whistler.com/" rel="external">http://www.whistler.com/</a></li>
   <li> Aloha Whistler - <a href="http://www.alohawhistler.com/whistler.php" rel="external">http://www.alohawhistler.com/whistler.php</a></li>
   <li> The Fairmont Chateau Whistler - <a href="http://www.fairmont.com/whistler/" rel="external">http://www.fairmont.com/whistler/</a></li>
   <li> Vancouver airport - <a href="http://www.yvr.ca/" rel="external">http://www.yvr.ca/</a></li>
   <li> (Later the K-CAP 2007 www site will include information on travel)</li>
</ul>

<h2>K-CAP 2007 ORGANISING COMMITTEE</h2>
 <table border="0" cellpadding="2" cellspacing="2">
   <tr>
     <td><strong>Conference Chair</strong></td>
     <td>Derek Sleeman (University of Aberdeen)</td>
   </tr>
   <tr>
     <td><strong>Program Chair</strong></td>
     <td>Ken Barker (University of Texas)</td>
   </tr>
   <tr>
     <td><strong>Workshop &amp; Tutorials Chair</strong></td>
     <td>John Gennari (University of Washington)</td>
   </tr>
   <tr>
     <td><strong>Local Arrangements</strong></td>
     <td>Rob Kremer (University of Calgary)</td>
   </tr>
   <tr>
     <td><strong>Publicity</strong></td>
     <td>Jeff Pan (University of Aberdeen)</td>
   </tr>
      <tr>
     <td><strong>Treasurer</strong></td>
     <td>John Thompson (Boeing Company)</td>
   </tr>
      <tr>
     <td><strong>Sponsorship (Co-Chairs)</strong></td>
     <td>Yolanda Gil (USC) &amp; <br /> David Leake (Indiana University)</td>
   </tr>
   <tr>
     <td><strong>Webmaster</strong></td>
     <td>David Corsar (University of Aberdeen)</td>
   </tr>
</table>


<h2>K-CAP STEERING COMMITTEE</h2>
Peter Clark (Boeing Company) <br />
Ken Forbus (Northwestern University) <br />
Yolanda Gil (USC) <br />
Rob Kremer (University of Calgary) <br />
Mark Musen (Stanford University) <br />
Jude Shavlik (University of Wisconsin at Madison) <br />
Derek Sleeman (University of Aberdeen) <br />

<h2>FURTHER INFORMATION</h2>
<p>
Further information is available from <a href="index.html">http://www.csd.abdn.ac.uk/kcap07/</a>
</p>
...
<p>
Other versions of this call for papers are also available: <a href="http://www.csd.abdn.ac.uk/kcap07/K-CAP07_CFPosters.txt">plain text</a>, <a href="http://www.csd.abdn.ac.uk/kcap07/K-CAP07_CFPosters.doc">Microsoft Word</a>, and <a href="http://www.csd.abdn.ac.uk/kcap07/K-CAP07_CFPosters.pdf">pdf</a>.
</p>

         <p style="text-align: right"><a href="cfposters.php#top">top</a></p>   
	   </td>
          </tr>
		  <tr>
