        ...
        <tbody>
          <tr>
            <td class="navcolumn" style="border-bottom: 1px solid #330066;vertical-align: middle;">
            	...
            	<img src="images/logo150.gif" alt="K-CAP 07 Logo" />
			</td>
...
<p>
The online registration is being handled via our <a href="http://www.regonline.co.uk/kcap07">RegOnline website</a>.  Please read the following instructions before proceeding with your registration: this page contains information on <a href="registration.php#fees">fees</a>,  <a href="registration.php#inc">what they include</a>,  <a href="registration.php#payment">payment methods</a>, <a href="registration.php#cancel">cancellation policy</a>,  <a href="registration.php#accommodation">accommodation</a>,  <a href="registration.php#transport">getting to Whistler</a>,  <a href="registration.php#sb">student bursaries</a>, and <a href="registration.php#sa">student assistants</a>
</p>

<a name="workshopfees"></a><h2>Workshop Fees (Sunday 28th October)</h2>
<p>
There are three levels of fees for K-CAP 2007 workshops: the standard rate; a discounted rate for members of the ACM and ACM SIGART members; 
along with a student rate.  Until September 17th 2007, we are also offering an early registration discount: the complete range of fees are provided below.
</p>

<p>
Attendees paying the workshop registration fees are entitled to attend one full day workshop, or two half day workshops.
</p>

<h3>Early Registration (before September 17th 2007)</h3>
<table class="feestable">
	...
	<tr>
		<td>ACM and ACM SIGART members</td>
		<td>&#36;40</td>
	</tr>
	<tr>
		<td>Student</td>
...
<h3>Normal Registration (between September 18th 2007 and October 21st 2007)</h3>
<table class="feestable">
	<tr>
		<th>Registration Type</th>
		<th>Price (USD)</th>
...
<a name="fees"></a><h2>Main Conference Fees (for Monday 29th, Tuesday 30th and Wednesday 31st October)</h2>
<p>
There are three levels of fees for the main K-CAP 2007 conference: the standard rate; a discounted rate for members of the ACM and ACM SIGART members; along with a student rate.  Until September 17th 2007, we are also offering an early registration discount: the complete range of fees are provided below.
</p>
...
<a name="inc"></a><h2>Included in the Conference Fees</h2>
Along with a copy of the proceedings of the main conference, the fees include
<ul>
	<li>The welcome reception on the Sunday evening.
	<li>A ticket for the conference banquet, which will take place in the evening of Monday the 29th October</li>
	<li>A poster reception, which will take place in the evening of Tuesday the 30th October.</li>
</ul>
<p>
If you have any dietary needs, allergies or other requirements you can either tell us on the relevant page of the registration procedure, or you should be able to <a href="http://www.regonline.co.uk/kcap07" rel="external">log in to RegOnline</a> and change your details; however to ensure we are aware of the changes, you may also wish to <a href="http://www.csd.abdn.ac.uk/kcap07/foodform.php">fill in this form</a>.
</p>

<p>
Other meals will not be provided by the conference; however there are various restaurants in Whistler Village, some of which are very close to the conference hotel.
</p>

<a name="payment"></a><h2>Payment Methods</h2>
<p>
You will be required to pay your registration fees when you register using the <a href="http://www.regonline.co.uk/kcap07" rel="external">RegOnline site</a>.  Accepted methods of payment are Visa, Mastercard, Discover, Diners Club and American Express credit cards.  These will also be accepted for on-site registration.  It is also possible to pay via wire/bank transfer (this option will not be available on-site): to do this, select the &quot;Wire Transfer&quot; payment option, complete registration and email David Corsar at dcorsar at abdn.ac.uk for details about making the transfer the money.
</p>

<a name="cancel"></a><h2>Cancellation Policy</h2>
<p>
Registered attendees who cancel their registration will be entitled to the following refund, based on when their cancellation is processed:
</p>
...
<table>
	...
	<tr>
		<td>	
			Between 29th August 2007 and 28th September 2007
		</td>
		<td>
			50&#37;
		</td>
	...
	<tr>
		<td>
			Between 29th September 2007 and 14th October 2007
		</td>
		<td>
			25&#37;
		</td>
...
<a name="transport"></a><h2>Transportation</h2>
<p>
...
<a name="sb"></a><h2>Student Bursaries</h2>
<p>
These are intended to contribute to the travel and living expenses for students participating in the K-CAP 2007 conference. We expect to allocate up to 6 such bursaries. First priority will be given to students who are co-authors of full papers (and preferably also presenting the paper at the conference). We also encourage students involved in posters and workshops to apply.
</p>
<p>
<strong>Application procedure:</strong> you should send an email by <strong>7 September</strong> to Derek Sleeman
(dsleeman at abdn.ac.uk) outlining the  activities  you will be involved in at K-CAP 2007, and an outline of the expected total cost in attending K-CAP 2007. You should also provide the name of your supervisor, your thesis topic and the name of your department. By the same deadline you should ask your supervisor to email  Derek Sleeman, with a statement confirming he / she is your supervisor, and confirming you are a registered research student.
</p>

<a name="sa"></a><h2>Student Assistants</h2>
<p>
We need up to 6 students to help us organize the workshop; duties will involve helping with registration (to be coordinated by David Corsar), with ensuring sessions have appropriate audio-visual equipment, and that the K-CAP 2007 wireless network is functioning, and to generally support the organizing committee. In return for these activities you will be allocated (possibly shared) free accommodation for 4 nights (from 27-31 October) in a twin bedded room at the conference hotel.
</p>
<p>
<strong>Application procedure:</strong> you should send an email by <strong>7 September</strong> to Derek Sleeman
(dsleeman at abdn.ac.uk) outlining what relevant experiences you might have, and an outline of your expected total cost to attend K-CAP 2007.  You should also provide the name of your supervisor, your thesis topic and the name of your department. By the same deadline you should ask your supervisor to email  Derek Sleeman, with a statement confirming he / she is your supervisor, and confirming you are a registered research student.
</p>

         <p style="text-align: right"><a href="registration.php#top">top</a></p>   
	   </td>
          </tr>
		  <tr>
