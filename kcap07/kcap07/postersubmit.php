...
<p>
K-CAP 2007 is using <a href="http://www.confmaster.net" rel="external">confmaster</a> to manage poster submissions,
 please go to the <a href="http://kcap07.confmaster.net">K-CAP 2007 confmaster page</a> (open in <a href="http://kcap07.confmaster.net" rel="external">new window</a>)
 and follow the following instructions.
</p>

<h2>Previously Registered K-CAP 2007 Authors</h2>
<ol>
	<li>Enter your user name and password</li>
	<li>If you have forgotten your password, use the &quot;Login or password forgotten?&quot; option to retrieve it</li>
</ol>

<h2>New K-CAP 2007 Authors</h2>
<ol>
	<li>Click on &quot;Register as new author&quot;</li>
	<li>Fill in all fields marked '*' on the &quot;Register as new author&quot; form</li>
	<li>Click on &quot;Submit&quot;</li>
</ol>

<p>
An email with your login and password will then been sent to your email address. 
After you have received the message with your login and password, you will be able to submit your paper, edit your data, 
and change your login and password details.
</p>

<h2>Registering Your Poster</h2>
<ol>
	<li>Once you have successfully logged in, select the &quot;Register Paper&quot; option of the left hand side</li>
	<li>Fill in the displayed form (all fields marked '*' are required).  You will see the paper type is already selected as &quot;Poster&quot;</li>
	<li>Select your paper using the &quot;Choose..&quot; button</li>
	<li>Press Submit</li>
	<li>You will see a confirmation screen, and you should get a confirmation email shortly</li>
</ol>

         <p style="text-align: right"><a href="postersubmit.php#top">top</a></p>   
	   </td>
          </tr>
		  <tr>
